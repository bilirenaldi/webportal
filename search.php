...
$st;
?>
   <title>Search Result <?php echo $st ?></title>
                        <!-- Catagory Area -->
                        <div class="world-catagory-area mt-50">
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                <li class="title">SHOWING RESULT <?php echo $st ?></li>
<?php 
     ...
     if (isset($_GET['pageno'])) {
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM tblposts  where PostTitle like '%$st%'";
...
<?php 
            $query = "select tblposts.id as pid,tblposts.PostTitle as posttitle,tblposts.id_user as iduser,tblposts.PostImage,tblcategory.CategoryName as category,tblusers.nama as user,tblsubcategory.Subcategory as subcategory,tblposts.PostImage as image,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId left join tblusers on tblusers.id where tblposts.PostTitle like '%$st%' and tblposts.Is_Active=1 LIMIT $offset, $no_of_records_per_page";
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="view-post.php?pid=<?php echo $id; ?>"> <img src="img/blog-img/<?php echo $image; ?>" height="360px" width = "195px" alt="<?php echo $title; ?>"> </a>
                                                    <!-- Catagory -->
